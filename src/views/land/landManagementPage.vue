  ...
  getLandJSON()
    .then((result) => {
      ...
      const styleFunction = (feature) => {
        ...
        const color = landColors[landName];
        return {
          fillColor: color,
          weight: 1,
          opacity: 0.1,
      ...
      const onEachFeature = (feature, layer) => {
        ...
        <div style="display:flex;flex-direction: column;align-items: flex-start; width: 140px;">
                        ...
                        <p style="margin:0"><strong>种植作物:</strong> ${cropName}</p>
      ...
      // 清除现有的作物和土地图层
      map.eachLayer((layer) => {
        if (layer instanceof L.GeoJSON && layer.options.layerType === "Land") {
